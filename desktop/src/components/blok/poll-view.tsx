  ...
  return (
    <div className="mt-2 border border-[var(--border)] rounded-lg bg-[var(--bg-elevated)] overflow-hidden max-w-sm">
      ...
      <div className="px-3 py-2 border-t border-[var(--border)] flex items-center gap-2">
        ...
        {hasVoted ? (
          <div className="flex items-center gap-1 text-[10px] text-[var(--accent-red)]">
          ...
          <button
            onClick={handleVote}
            className="text-[10px] px-2.5 py-1 rounded bg-[var(--accent-red)] hover:opacity-90 text-white transition-opacity"
          >
            {t("poll.vote")}
          </button>
        ) : null}
