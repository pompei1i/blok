    ...
    >
      <div className="bg-[var(--bg-elevated)] border border-[var(--border)] w-76 shadow-2xl overflow-hidden" style={{ width: 300 }}>
        ...
        >
          <button
            onClick={onClose}
            className="absolute top-2 right-2 p-1 bg-[var(--bg-surface)] border border-[var(--border)] text-[var(--text-muted)] hover:text-[var(--text-primary)] hover:bg-[var(--bg-hover)] transition-colors"
          >
        ...
        <div className="px-4 -mt-8 mb-3">
          <div className="relative ring-4 ring-[var(--bg-elevated)] rounded-full w-fit">
        ...
        <div className="px-4 pb-3">
          <div className="flex items-start justify-between gap-2">
            <div className="min-w-0">
              <p className={cn("font-bold text-[var(--text-primary)] leading-tight truncate", np.className)} style={np.style}>{displayName}</p>
              <p className="text-xs text-[var(--text-muted)]">@{user.username}</p>
            </div>
            <div className="flex-shrink-0 flex items-center gap-1.5 px-2.5 py-1 rounded-full border border-[var(--border)] bg-[var(--bg-surface)]">
