          ...
          <div className="space-y-1">
            {QUICK_COMMANDS.map(({ key, prompt }) => (
              <button
                ...
                className="w-full text-left px-2 py-1.5 text-xs font-mono text-[var(--text-muted)] transition-all duration-150 border border-dashed border-[var(--border)] hover:border-solid hover:border-[var(--text-primary)]/30 hover:bg-[var(--bg-hover)] hover:text-[var(--text-primary)]"
              >
