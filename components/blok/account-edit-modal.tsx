...
import { X, Camera, Save, User, Video, Mic, Keyboard, Layout, Palette, Globe, LogOut, CheckCircle, XCircle, AlertCircle } from "lucide-react";
...
export function AccountEditModal({ isOpen, onClose }: AccountEditModalProps) {
  ...
  const {
    previewVideo, mirrorCamera, cameraQuality,
    noiseSuppression, echoCancellation, inputVolume, noiseGateThreshold,
    pushToTalk, compactMode, showMemberList, themeMode, uiScale, language, customCss,
    setSetting,
  } = useUiSettingsStore();
  ...
  useEffect(() => {
    ...
    isOpen, previewVideo, mirrorCamera, cameraQuality,
    noiseSuppression, echoCancellation, inputVolume, noiseGateThreshold,
    pushToTalk, compactMode, showMemberList, themeMode, uiScale, language, customCss,
  ]);
  ...
  const handleApplySettings = async () => {
    ...
    setSettingsMessage(null);
    (Object.entries(draftSettings) as Array<[keyof SettingsDraft, SettingsDraft[keyof SettingsDraft]]>)
        ...
        <div className="flex-1 flex flex-col bg-[var(--bg-base)] overflow-hidden relative">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="relative group">
                      <div className="w-24 h-24 rounded-2xl flex items-center justify-center text-3xl font-bold border-2 border-[var(--border)] overflow-hidden shadow-lg bg-[var(--accent-red)]">
                        {(avatarPreview || user?.avatarUrl) ? (
                          ...
                          <span className="text-white">{formData.displayName?.[0]?.toUpperCase() || "U"}</span>
                        )}
                      </div>
                      <button
                        type="button"
                  ...
                  {message && (
                    <div className={cn(
                      ...
                      <div className={cn("w-2 h-2 rounded-full", message.type === "success" ? "bg-[var(--online)]" : "bg-[var(--destructive)]")} />
                      {message.text}
                    </div>
                  )}
              ...
              <div className="max-w-2xl animate-fade-in space-y-6">
                ...
                <div className="p-6 bg-[var(--bg-surface)] border border-[var(--border)] rounded-xl space-y-5">
                  <label className="flex items-center justify-between">
                    ...
                    <input type="checkbox" checked={draftSettings.previewVideo}
                  ...
                  <label className="flex items-center justify-between">
                    ...
                    <input type="checkbox" checked={draftSettings.mirrorCamera}
              ...
              <div className="max-w-2xl animate-fade-in space-y-6">
                ...
                <div className="p-6 bg-[var(--bg-surface)] border border-[var(--border)] rounded-xl space-y-5">
                  <label className="flex items-center justify-between">
                    ...
                    <input type="checkbox" checked={draftSettings.noiseSuppression}
                  ...
                  <label className="flex items-center justify-between">
                    ...
                    <input type="checkbox" checked={draftSettings.echoCancellation}
                  ...
                  <label className="block">
                    ...
                    <input type="range" min={0} max={100} value={draftSettings.inputVolume}
                  ...
                  <label className="block">
                    ...
                    <p className="text-xs text-[var(--text-muted)] mb-2">Cuts audio below this volume threshold.</p>
                    <input type="range" min={0} max={100} value={draftSettings.noiseGateThreshold}
              ...
              <div className="max-w-2xl animate-fade-in space-y-6">
                ...
                <div className="p-6 bg-[var(--bg-surface)] border border-[var(--border)] rounded-xl space-y-4">
                  <label className="flex items-center justify-between">
                    ...
                    <input type="checkbox" checked={draftSettings.pushToTalk}
              ...
              <div className="max-w-2xl animate-fade-in space-y-6">
                ...
                <div className="p-6 bg-[var(--bg-surface)] border border-[var(--border)] rounded-xl space-y-5">
                  <label className="flex items-center justify-between">
                    ...
                    <input type="checkbox" checked={draftSettings.compactMode}
                  ...
                  <label className="flex items-center justify-between">
                    ...
                    <input type="checkbox" checked={draftSettings.showMemberList}
                  ...
                  <label className="block">
                    ...
                    <input type="range" min={80} max={120} value={draftSettings.uiScale}
              ...
              <div className="max-w-2xl animate-fade-in space-y-6">
                ...
                <div className="p-6 bg-[var(--bg-surface)] border border-[var(--border)] rounded-xl space-y-3">
                  <div>
                    ...
                    <p className="text-xs text-[var(--text-muted)]">Inject your own CSS to fully customize the UI.</p>
                  </div>
                  <textarea
          ...
          {activeTab !== "account" && (
            <div className="border-t border-[var(--border)] px-8 lg:px-12 py-4 bg-[var(--bg-surface)] flex items-center justify-between gap-3">
              <span className="text-xs text-[var(--text-muted)]">{t("settings.applyHint")}</span>
              <div className="flex items-center gap-3">
                {settingsMessage && <span className="text-xs text-[var(--online)]">{settingsMessage}</span>}
                <button
                  type="button"
