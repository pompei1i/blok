...
- [x] i18n система на JSON-файлах: 6 языков (EN/RU/UA/PL/DE/ES), 140+ ключей, zero-runtime overhead.
- [x] Настройки браузера: 7 вкладок (аккаунт, видео, аудио, хоткеи, вид, тема, язык).
- [x] Все браузерные компоненты переведены на i18n (auth, chat, friends, user-bar, emoji/mention/attachment picker).
...
- [x] Нативный выбор источника экрана (кастомный пикер мониторов и окон без системного диалогва WebView2).
